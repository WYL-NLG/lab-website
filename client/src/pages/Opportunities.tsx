                  ...
                  >
                    <div className="flex flex-col lg:flex-row lg:items-start gap-6">
                      <div className="flex items-center gap-4 lg:w-72 shrink-0">
                        ...
                        <div>
                          <h3 className="text-lg font-display text-foreground">{opp.title}</h3>
                          <p className="text-xs text-muted-foreground tracking-wider">{opp.subtitle}</p>
                        </div>
                      </div>
                      <div className="flex-1">
                        <p className="text-sm text-muted-foreground leading-relaxed mb-4">{opp.desc}</p>
                        <div className="mb-4">
